...
import {
  ...
  ApiNode, FilterNode, TransformNode, NoteNode, MergeNode,
} from './nodes/index';
  ...
  return (
    <div className="canvas-wrapper" ref={reactFlowWrapper}>
      <ReactFlow
        ...
        fitView
      >
        <Background color="#2a2f3e" gap={gridSize} />
        <Controls />
        <MiniMap
          nodeColor={(n) => {
            const colors = {
              customInput: '#10b981', llm: '#8b5cf6', customOutput: '#f59e0b',
              text: '#ec4899', api: '#0ea5e9', filter: '#f97316',
              transform: '#14b8a6', note: '#eab308', merge: '#db2777',
            };
